        ...
        return <Container>
                    <Card bg="white" className="text-center shadow my-5">
                        ...
                        <Card.Body className='p-5'>
                            ...
                            <br></br>
                            <Selection highlightedFilter={this.state.highlightedFilter} onSelectionChange={this.handleSelectionChange}/>
                            <ToDoList todos={this.state.todos} highlightedFilter={this.state.highlightedFilter} onStatusChange={this.handleStatusChange}/>
                        </Card.Body>
                    </Card>
                </Container>
    }
